...
import Rubix from '../../../../../static/js/common/rubix/rubix';
const d3 = require('d3');
...
class MainChart extends Component {
  componentDidMount() {
    ...
    const vv = [5, 10, 2, 20, 40, 35, 30, 20, 25, 10, 20, 10, 20, 15, 25, 20, 30, 25, 30, 25, 30, 35, 40, 20, 15, 20, 10, 25, 15, 20, 10, 25, 30, 30, 25, 20, 10, 50, 60, 30];
