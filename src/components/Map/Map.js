...
export default class Map extends Component {
  componentDidMount() {
    ...
    var mapInit = L.mapbox.map('map', 'brucelee.jbk1b284');
    var map = mapInit.setView([38.909671288923, -77.034084142948], 13)
    ...
    locations.eachLayer(function(locale) {
      ...
      link.onclick = (function(m) {
        ...
        return function() {
          ...
          m.setView(locale.getLatLng(), 16);
          locale.openPopup();
          return false;
        }
      })(mapInit);
      // link.onclick.bind({map: map});
