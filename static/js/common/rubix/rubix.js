...
Rubix.prototype._brush_nochange = () => {
  try {
...
Rubix.prototype._setupLinearAxis = () => {
...
/** @private */
Rubix.prototype._cleanElement = () => {
  this.elem.children().remove();
};

/** @private */
Rubix.prototype._setSize = () => {
...
Rubix.prototype._createBrushPath = () => {
  let self = this;
...
Rubix.prototype.resetLabelHandlers = () => {
  let self = this;
...
Rubix.prototype.line_series = function(opts) {
  ...
  let line_series = new Rubix.LineSeries(this, opts);
...
Rubix.prototype.area_series = function(opts) {
  ...
  let area_series = new Rubix.AreaSeries(this, opts);
...
Rubix.prototype._generate_name = () => {
...
Rubix.prototype.column_series = function(opts) {
  ...
  let column_series = new Rubix.ColumnSeries(this, opts);
...
Rubix.StackedAreaSeries.prototype._animate_draw = () => {
...
Rubix.StackedAreaSeries.prototype.hidden = () => {
  this.chart_hidden = true;
};

Rubix.StackedAreaSeries.prototype.show = () => {
  this.chart_hidden = false;
...
Rubix.StackedAreaSeries.prototype.on_complete_draw = () => {
...
Rubix.StackedAreaSeries.prototype.setupFocus = () => {
  if (!this.setup) return;
...
Rubix.StackedAreaSeries.prototype.onFocus = () => {
  if (!this.setup) return;
  this.linePath.attr('stroke-width', 2 * this.opts.strokewidth);
};

Rubix.StackedAreaSeries.prototype.offFocus = () => {
  if (!this.setup) return;
  this.linePath.attr('stroke-width', 2 * this.opts.strokewidth);
};
// window.Rubix = window.Rubix || {};
...
Rubix.PieDonut.prototype.setup = () => {
  this.setupOpts();
  this.setupOnce();
  this.setupRedraw();
...
/** @private */
Rubix.PieDonut.prototype.setupOpts = () => {
...
/** @private */
Rubix.PieDonut.prototype.setupOnce = () => {
  // Add Pie Stack data here.
};

Rubix.PieDonut.prototype.setupRedraw = () => {
  let self = this;
...
/** @private */
Rubix.PieDonut.prototype._cleanElement = () => {
  this.elem.children().remove();
};

/** @private */
Rubix.PieDonut.prototype._setSize = () => {
  this.outerWidth  = this.elem.width();
  this.outerHeight = this.elem.height();
...
/** @private */
Rubix.PieDonut.prototype._setupCanvas = () => {
  this.elem.html('');
  this.canvas = d3.select(this.elem.get(0)).append('svg');
  this.canvas.attr('width', this.outerWidth);
  this.canvas.attr('height', this.outerHeight);
...
/** @private */
Rubix.PieDonut.prototype._setupRoot = () => {
  this.root = this.canvas.append('g');
  this.root.attr('width', this.width);
  this.root.attr('height', this.height);
  this.root.attr('transform', 'translate(' +this.margin.left+',' +this.margin.top+')');
...
Rubix.PieDonut.prototype._setupSeries = () => {
...
Rubix.PieDonut.prototype._setupLegend = () => {
  let self = this;
...
Rubix.LineSeries.prototype._animate_draw = () => {
  let text = this.root.selectAll('.y.axis').selectAll('text')[0];
  let width = [];
  for(let i = 0; i < text.length; i++) {
    width.push(text[i].getBBox().width);
...
Rubix.LineSeries.prototype.hidden = () => {
  this.chart_hidden = true;
};

Rubix.LineSeries.prototype.show = () => {
  this.chart_hidden = false;
  while(this.temp_stack.length>1) {
    let rawData = this.temp_stack.shift();
    if (rawData.type === 'addPoint') {
...
Rubix.LineSeries.prototype.on_complete_draw = () => {
  if (!this.setup) return;
  let self = this;
  let datum = this.data[this.name];
  if (this.opts.marker !== undefined && this.show_markers) {
...
Rubix.LineSeries.prototype.setupFocus = () => {
  if (!this.setup) return;
  if (this.focus) this.focus.remove();
  this.focus = this.rubix.focus_group.append('g');
  this.focus.attr('class', 'focus');
...
Rubix.LineSeries.prototype.onFocus = () => {
  if (!this.setup) return;
  this.linePath.attr('stroke-width', 2 * this.opts.strokewidth);
};

Rubix.LineSeries.prototype.offFocus = () => {
  if (!this.setup) return;
  this.linePath.attr('stroke-width', 2 * this.opts.strokewidth);
};
// window.Rubix = window.Rubix || {};
...
Rubix.ColumnSeries.prototype._createRect = () => {
  let self = this;
...
Rubix.ColumnSeries.prototype._animate_draw = () => {
  try {
    let text = this.root.selectAll('.y.axis').selectAll('text')[0];
    let width = [];
    for(let i = 0; i < text.length; i++) {
...
Rubix.ColumnSeries.prototype.hidden = () => {
  this.chart_hidden = true;
};

Rubix.ColumnSeries.prototype.show = () => {
  this.chart_hidden = false;
  while(this.temp_stack.length>1) {
    let rawData = this.temp_stack.shift();
    if (rawData.type === 'addPoint') {
...
Rubix.ColumnSeries.prototype.on_complete_draw = () => {
  if (!this.setup) return;
  let strokecolor = 'white';
  let self = this;
  if (this.opts.marker !== undefined && this.show_markers) {
...
Rubix.ColumnSeries.prototype.setupFocus = () => {
  if (!this.setup) return;
  if (this.focus) this.focus.remove();
  this.focus = this.rubix.focus_group.append('g');
  this.focus.attr('class', 'focus');
...
Rubix.ColumnSeries.prototype.onFocus = function(dx, dy) {
  if (!this.setup) return;
  this.offFocus();
  if (this.rubix.opts.invertAxes) {
...
Rubix.ColumnSeries.prototype.offFocus = () => {
  if (!this.setup) return;
...
Rubix.AreaSeries.prototype.hidden = () => {
  this.chart_hidden = true;
};

Rubix.AreaSeries.prototype.show = () => {
  this.chart_hidden = false;
  while(this.temp_stack.length>1) {
    let rawData = this.temp_stack.shift();
    if (rawData.type === 'addPoint') {
...
Rubix.AreaSeries.prototype.on_complete_draw = () => {
  if (!this.setup) return;
  let self = this;
  let datum = this.data[this.name];
  if (this.opts.marker !== undefined && this.show_markers) {
...
Rubix.AreaSeries.prototype.setupFocus = () => {
  if (!this.setup) return;
  if (this.focus) this.focus.remove();
  this.focus = this.rubix.focus_group.append('g');
  this.focus.attr('class', 'focus');
...
Rubix.AreaSeries.prototype.onFocus = () => {
  if (!this.setup) return;
  this.linePath.attr('stroke-width', 2 * this.opts.strokewidth);
};

Rubix.AreaSeries.prototype.offFocus = () => {
  if (!this.setup) return;
  this.linePath.attr('stroke-width', 2 * this.opts.strokewidth);
};
